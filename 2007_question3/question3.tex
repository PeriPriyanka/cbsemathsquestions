...
%
\begin{lstlisting}
https://github.com/PeriPriyanka/cbsemathsquestions/2007_question3
\end{lstlisting}
\section{Problem}
...
\end{align}
The above equations 2.0.1 and 2.0.2 can be rearranged as the following equations
\begin{align}
3X+2Y=47\\
2X+3Y=53
\end{align}
...
\vec{AX=B}
\end{align}
From the equations 2.0.3 and 2.0.4, 
\begin{align}
\vec{A}= \myvec{3 &2\\2 & 3}\\
\medskip
\vec{X}= \myvec{ X\\ Y}\\
...
\vec{B}= \myvec{47\\53}  
\end{align} 
Substituting the values of $\vec{A}$, $\vec{X}$ and $\vec{B}$ in the equation 2.0.5
We get,
\begin{align}
...
Considering the augmented matrix $\vec{AB}$
 \begin{align}
 \vec{AB}= \myvec{3&2&47\\2&3&53}
 \end{align}
 Performing the row operation on $\vec{AB}$
 \begin{center}
 $R_2 \rightarrow 3R_2 - 2R_1$
 \end{center}
 \begin{align}
  \vec{AB}= \myvec{3&2&47\\0&5&65}
 \end{align}
 \begin{align}
...
5Y=65
\end{align}
By solving equations 2.0.14 we get,
\begin{align}
Y= 13\
\end{align}
and by solving equation 2.0.13 we get ,
\begin{align}
X=7
\end{align}
Therefore, X=7 and Y= 13 are solutions to the given equations 1.0.1 and 1.0.2
\end{document}