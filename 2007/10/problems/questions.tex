...
\resizebox{\columnwidth}{!}{
\begin{tabular}{ l l  }
 (a)\textbf {Savings:} & 100\% exemption for permissible savings upto Rs. 1,00,000 \\ \\
 (b)\textbf Rates of income tax for ladies \\\\
  \tab \textbf{\underline {Slab}}& \tab  \textbf{\underline {Income tax}}\\\\
\tab  (i) Upto Rs. 1,35,000&No tax\\\\
\tab  (ii) From Rs.1,35,001 to Rs. 1,50,000& 10\%of taxable income exceeding Rs. 1,35,000\\\\
\tab (iii) From Rs. 1,50,001 to Rs.2,50,000& Rs. 1,500+20\%of the amount exceeding Rs. 1,50,000\\\\
\tab (iv) From Rs. 2,50,001 and above&Rs. 21,500+30\%of the amount exceeding Rs. 2,50,000\\\\
\tab  (c) \textbf {Education Cess:}& 2\% of Income tax payable 
\end{tabular} }
\end{table}
\end{enumerate}
\end{document}