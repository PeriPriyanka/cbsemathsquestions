...
\item P  and Q are points on the sides $\vec{CA}$ and $\vec{CB}$ respectively of $\triangle{ABC}$, right angled at C. Prove that
\begin{center}
...
\begin{figure}[h!]
 ...
 \medskip 
 \item Draw a $\triangle{PQR}$ with the base $\vec{QR}$=6cm, vertical angle P= 60$\degree$ and median through P to the base is of length 4.5cm.
 \medskip
